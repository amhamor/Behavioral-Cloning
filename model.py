...
training_driving_log_file_path = './driving_log.csv'
#validation_driving_log_file_path = './training_data/validation_driving_log.csv'

weights_file_path = None#"model_checkpoint_1_0.00124.hdf5"
batch_size = 64
initial_epoch = 0
epochs = 10000
...
checkpoint = ModelCheckpoint(filepath='model_checkpoint_{epoch}_{loss:.5f}.hdf5')
