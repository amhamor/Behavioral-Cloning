...
weights_file_path_list = ['model_checkpoint_training_driving_log.csv_1_0.16980559089078187.hdf5']
...
for training_driving_log_file_path, weights_file_path in zip(training_driving_log_file_path_list, weights_file_path_list):
	...
	#validation_row_count, image_shape = get_row_count_and_image_shape(csv_file_path=validation_driving_log_file_path)
	...
	train_model(train_generator=train_generator, nb_epoch=nb_epoch, checkpoint=checkpoint, batch_size=batch_size, samples_per_epoch=train_image_count, initial_epoch=initial_epoch, image_shape=image_shape, weights_file_path=weights_file_path)
